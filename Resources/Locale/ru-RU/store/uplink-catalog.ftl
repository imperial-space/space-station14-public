...
uplink-chimp-upgrade-kit-name = Чип улучшения револьвера Р.И.Ч.
uplink-chimp-upgrade-kit-desc = Вставьте этот чип в стандартный Р.И.Ч., чтобы он смог стрелять омега-частицами. Омега-частицы причиняют сильные ожоги и способствуют переходу аномалий в сверхкритическое состояние.
...
uplink-clothing-outer-vest-web-desc = Синтетический бронежилет. У этого есть дополнительные ремни и баллистические пластины.
